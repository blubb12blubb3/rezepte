...
List<Map> recipes = [
  {
    ...
    "imageUrl":
        "https://media.istockphoto.com/id/1398775611/de/foto/kaiserschmarrn-frisch-und-hausgemacht.jpg?s=1024x1024&w=is&k=20&c=yvZTLabFv-09-Dzwl8mhq1rjaalXSMCGWhHH4iB4-ZM=",
  }
];
...
Future<String> fetchImage(String query) async {
  final response = await http.get(
      ...
      headers: {
        'Authorization':
            'BWgFbPpPn5IZfTglCRWZNGy1uzfVraOHgruRHUiVF1RxH72YcZ4EJkec'
      });
